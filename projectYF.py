...
def MyGMM(image, numClust, connectNeighbors=4, imageType='RGB', filterType=None): 
...
def MySpectral(image, numClust, connectNeighbors=4, imageType='RGB', scaleFactor=0.3, affinity='nearest_neighbors', n_neighbors=20, n_jobs=-1):
    # imageType: 'RGB' or 'Hyper'
    validateNumClust(numClust)
    """
    if filterType == 'mean':
